 ...
 */
export class ProductRead2DataSource extends DataSource<ProductModel> {
   ...
   */
  private getPagedData(data: ProductModel[]): ProductModel[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ProductModel[]): ProductModel[] {
